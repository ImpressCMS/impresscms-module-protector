...
//define("_AM_ADV_RESCUEPASSWORD","Пароль для снятия бана с вашего IP"); // Not present in english...
//define("_AM_ADV_RESCUEPASSWORDUNSET","Не установлен"); // Not present in english...
//define("_AM_ADV_RESCUEPASSWORDSHORT","Слишком короткий (минимальная длина 6 символов)");
//define( "_AM_TH_ENABLEIPBANS" , "Включить механизм банов по IP?" ) ; // Not present in english...
//define( "_AM_MSG_PRUPDATED" , "Настройки успешно обновлены!" ) ; // Not present in english...
//define("_AM_ADV_AT1STSETPASSWORD","Установите ваш резервный пароль перед проверкой."); // Not present in english...
