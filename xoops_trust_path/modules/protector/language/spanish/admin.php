...
define( "_AM_TH_BADIPS" , 'Lista de IPs bloqueadas (baneadas)<br /><br /><span style="font-weight:normal;">Escriba cada IP en una línea.<br />Todo en blanco, todas las IPs tienen permiso.</span>' ) ;
...
define( "_AM_JS_COMPACTLOGCONFIRM" , "Eliminar los registro duplicados (por IP y Tipo)" ) ;
...
define("_AM_ADV_TRUSTPATHPUBLIC","Si ve una imagen -NG- o el enlace dirige a una página normal, su XOOPS_TRUST_PATH no está adecuadamente situado. El mejor lugar es fuera del directorio raíz en el que está su sitio instalado. Si por la configuración de su alojamiento no puede hacer esto, debe crear un archivo .htaccess (DENY FROM ALL) justo bajo XOOPS_TRUST_PATH como la segunda mejor solución.");
define("_AM_ADV_TRUSTPATHPUBLICLINK","Comprueba que los archivos php dentro de TRUST_PATH no tienen acceso público (debe retornar un error 404,403 o 500");
...
define("_AM_ADV_MAINUNPATCHED","Debe editar mainfile.php como se recomienda en README.");
