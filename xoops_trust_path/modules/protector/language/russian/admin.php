...
define("_AM_ADV_TRUSTPATHPUBLIC","Если Вы можете получить доступ к изображению -NG- или ссылка возвращает нормальную страницу, то Ваш трастовый путь XOOPS_TRUST_PATH размещен неверно. Лучшее размещение для трастового пути XOOPS_TRUST_PATH за пределами DocumentRoot. Если Вы не можете этого сделать, тогда напишите в файле .htaccess, расположенном в трастовом пути XOOPS_TRUST_PATH строку DENY FROM ALL.");
define("_AM_ADV_TRUSTPATHPUBLICLINK","Проверьте, что php файлы в TRUST_PATH приватны (это должны быть ошибки 404,403 или 500");
